...
const BLINK_STEPS = 4
const BLINK_OPACITIES = [0.38, 1, 0.38, 1]
...
function drainHeight(col, drainTick) {
...
export function DotmSquare8({
  ...
  return <DotMatrixBase {...rest} speed={speed} pattern={pattern} animated={animated} phase={matrixPhase} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} reducedMotion={reducedMotion} animationResolver={resolver} />
}
